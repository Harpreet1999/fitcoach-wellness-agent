  ...
  return (
    <div className="my-1.5 p-3.5 sm:p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm animate-fade-up">
      <div className="flex items-start gap-2.5 mb-2.5">
        <div className="p-1.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 border border-neutral-200/60 dark:border-neutral-700/60 shrink-0">
          {renderCategoryIcon(data.category)}
        </div>
        <div>
          <div className="text-[9px] font-mono uppercase tracking-widest text-neutral-500 capitalize">
            {data.category} Protocol
          </div>
          <div className="text-xs sm:text-sm font-semibold text-neutral-800 dark:text-white mt-0.5">
            {data.title}
          </div>
        </div>
        <span className="ml-auto text-[9px] font-mono text-neutral-600 dark:text-neutral-400 bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded whitespace-nowrap shrink-0 border border-neutral-200 dark:border-neutral-700">
          {data.frequency}
        </span>
      </div>

      <p className="text-xs text-neutral-600 dark:text-neutral-300 leading-relaxed font-light mb-2.5">
        {data.description}
      </p>

      <div className="p-2.5 rounded-lg bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200/80 dark:border-neutral-700/50 mb-2.5">
        <div className="flex items-start gap-2">
          <Lightbulb className="w-3 h-3 text-neutral-600 dark:text-neutral-400 mt-0.5 shrink-0" />
          <div>
      ...
      <div className="flex items-center gap-1.5 text-[9px] font-mono text-neutral-500">
        <CheckCircle2 className="w-2.5 h-2.5 text-neutral-700 dark:text-neutral-400" />
